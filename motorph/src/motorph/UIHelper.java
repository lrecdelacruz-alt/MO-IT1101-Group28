...
public class UIHelper {
    ...
    public static final Color BLUE    = new Color(47, 87, 138);
    public static final Color RED     = new Color(183, 28, 28);
    public static final Color AMBER   = new Color(230, 120, 0);
    public static final Color GRAY    = new Color(190, 195, 200);
    public static final Color COMPUTE = new Color(21, 101, 192);
}